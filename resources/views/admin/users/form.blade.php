...
<div class="col-md-6">
    ...
    <input class="form-control" name="temp_id" type="hidden" id="temp_id" value="{{ $user->temp_id or uniqid() }}" >
...
<input class="form-control" name="role" type="hidden" id="role" value="user" >
